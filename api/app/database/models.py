...
class Project:
    def __init__(self, id: int, name: str, template: str, docker_container: Optional[str] = None, 
...
class ConversationMessageCreate:
    def __init__(self, session_id: str, project_id: Optional[int] = None, role: str = "", 
                 content: str = "", model: Optional[str] = None, provider: Optional[str] = None):
        self.session_id = session_id
        self.project_id = project_id
        self.role = role
...
class ConversationMessage:
    def __init__(self, id: int, session_id: str, project_id: Optional[int] = None, 
                 role: str = "", content: str = "", model: Optional[str] = None, 
                 provider: Optional[str] = None, token_usage_id: Optional[int] = None, 
...
class TokenUsageCreate:
    def __init__(self, session_id: str, project_id: Optional[int] = None, model: str = "", 
...
class ChatResponse:
    def __init__(self, type: str, content: str, session_id: str, project_id: Optional[int] = None):
        self.type = type
        self.content = content
        self.session_id = session_id
        self.project_id = project_id
